...
drop function if exists public.update_shipment_totals(integer);
...
begin
    -- Calcular el total de contado sumando los montos de las facturas de Consumidor Final
...
grant execute on function public.update_shipment_totals(integer) to authenticated;
grant execute on function public.update_shipment_totals(integer) to service_role;
